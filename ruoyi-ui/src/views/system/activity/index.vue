<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="图文" prop="essay">
        <el-input
          v-model="queryParams.essay"
          placeholder="请输入图文"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="举办人" prop="organizer">
        <el-input
    ...
    <el-table v-loading="loading" :data="activityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="图文" align="center" prop="essay" />
      <el-table-column label="举办人" align="center" prop="organizer" />
      <el-table-column label="举办时间" align="center" prop="holdTime" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="图文" prop="essay">
          <el-input v-model="form.essay" placeholder="请输入图文" />
        </el-form-item>
        <el-form-item label="举办人" prop="organizer">
          <el-input v-model="form.organizer" placeholder="请输入举办人" />
        </el-form-item>
        <el-form-item label="举办时间" prop="holdTime">
          <el-date-picker clearable
