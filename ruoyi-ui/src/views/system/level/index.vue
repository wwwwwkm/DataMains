<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="制度说明" prop="description">
        <el-input
    ...
    <el-table v-loading="loading" :data="levelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="栏目图标" align="center" prop="icon" />
      <el-table-column label="制度说明" align="center" prop="description" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="栏目图标" prop="icon">
          <el-input v-model="form.icon" placeholder="请输入栏目图标" />
        </el-form-item>
        <el-form-item label="制度说明" prop="description">
          <el-input v-model="form.description" placeholder="请输入制度说明" />
        </el-form-item>
      </el-form>
