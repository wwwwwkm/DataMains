<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="0:未读,1:已读" prop="isRead">
        <el-input
    ...
    <el-table v-loading="loading" :data="messageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属会员" align="center" prop="memberId" />
      <el-table-column label="发布人" align="center" prop="publisher" />
      <el-table-column label="消息类型 1:系统通知,2:活动通知,3:普通消息" align="center" prop="messageType" />
      <el-table-column label="内容" align="center" prop="content" />
      <el-table-column label="0:未读,1:已读" align="center" prop="isRead" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="所属会员" prop="memberId">
          <el-input v-model="form.memberId" placeholder="请输入所属会员" />
        </el-form-item>
        <el-form-item label="发布人" prop="publisher">
        ...
        <el-form-item label="0:未读,1:已读" prop="isRead">
          <el-input v-model="form.isRead" placeholder="请输入0:未读,1:已读" />
        </el-form-item>
        <el-form-item label="${comment}" prop="createdTime">
          <el-date-picker clearable
  ...
  data() {
    return {
      ...
      rules: {
        ...
        messageType: [
          { required: true, message: "消息类型 1:系统通知,2:活动通知,3:普通消息不能为空", trigger: "change" }
        ],
        content: [
